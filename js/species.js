...
export const SPECIES = [
  {
    ...
    name: "Leafcutter",
    latin: "Atta",
    flavour: "She does not eat what she carries. The colony farms a fungus, and the fungus feeds the colony. Atta, in the books.",
  ...
  },
  {
    ...
    name: "Fire ant",
    latin: "Solenopsis",
    flavour: "Many queens, one nest, and a sting that ends the argument. Solenopsis, in the books.",
  ...
  },
  {
    ...
    name: "Carpenter ant",
    latin: "Camponotus",
    flavour: "She carries a bacterium in her gut that makes protein out of waste, and she cuts her chambers from wood. Camponotus, in the books.",
  ...
  },
  {
    ...
    name: "Army ant",
    latin: "Eciton",
    flavour: "No nest at all. The colony is the nest, and it moves. Eciton, in the books.",
  ...
  },
  {
    ...
    name: "Honeypot ant",
    latin: "Myrmecocystus",
    flavour: "The store is not a room. It is a row of living ants hanging from the ceiling, swollen with what the colony brought home. Myrmecocystus, in the books.",
  ...
  },
  {
    ...
    name: "Amazon ant",
    latin: "Polyergus",
    flavour: "Her mandibles are sabres. They are very good for fighting and no good at all for work, so the work is done by somebody else's daughters. Polyergus, in the books.",
